...
import { Typography, Grid, Grow, Toolbar, Rating, Tooltip} from '@mui/material';
import useStyles from "./moviestyles";
import { Link } from 'react-router-dom';

const Movie = ({movie, i}) => {

    const classes = useStyles();<img src={movie.poster_path ? `https://image.tmdb.org/t/p/w500/${movie.poster_path}` : 'https://i.ibb.co/ft4skBS/logored.png' } alt={movie.title} />
